...
<link rel="shortcut icon" href="image/logo_chat.jpg">
			...
			<div class="col-md-4 col-sm-12">
				<div class="card" style="margin: 20px;">
				  ...
				  <div class="card-body">
				    ...
				    <a href="profile?deactivate=<%= session.getAttribute("user_id") %>" style="float: right; margin-left: 10px;" class="btn btn-danger">Delete</a>
